  ...
  return (
    <div className='w-full lg:flex hidden justify-center items-center  h-[20vh] mt-5 relative'>
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 left-5 z-10">
        <button onClick={handlePrev} className="bg-white rounded-full p-2 shadow-md hover:bg-gray-200 transition">
          &#10094;
        </button>
      </div>
      <div className="absolute top-1/2 transform -translate-y-1/2 right-5 z-10">
        <button onClick={handleNext} className="bg-white rounded-full p-2 shadow-md hover:bg-gray-200 transition">
          &#10095;
        </button>
      </div>
    </div>
